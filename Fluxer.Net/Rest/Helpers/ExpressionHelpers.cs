...
public static class ExpressionHelpers
{
    ...
    public static Task ModifyAsync(this GuildEmoji emoji, string name)
        => emoji.Client.Rest.UpdateEmojiAsync(emoji.GuildId, emoji.Id, new GuildEmojiUpdateRequest
        {
            Name = name
        });
    ...
    public static Task ModifyAsync(this GuildSticker sticker, GuildStickerUpdateRequest request)
