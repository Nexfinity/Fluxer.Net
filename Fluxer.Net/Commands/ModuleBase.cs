    ...
    where T : class, ICommandContext
{
    ...
    {
        return await Context.Client.Rest.SendMessageAsync(Context.Channel.Id, content, embeds, reference, allowedMentions, flags, nonce, favoriteMediaId, tts, stickerIds, attachments);
    }
